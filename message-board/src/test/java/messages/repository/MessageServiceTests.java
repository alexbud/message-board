...
public abstract class MessageServiceTests {
	...
	/**
	 * Test for {@link HibernateMessageService#getAllMessages()}.
	 */
	@Test
	...
	/**
	 * Test for {@link HibernateMessageService#getMessage()}.
	 */
	@Test
	@Transactional
	public void testGetMessage() {
		...
		assertEquals("wrong sender", "Keith", message.getSender());
	...
	/**
	 * Test for {@link HibernateMessageService#update(Message)}.
	 */
	@Test
	@Transactional
	...
	/**
	 * Test for {@link HibernateMessageService#update(Message)}. Authorization
	 * test for update and delete a message.
	 */
	@Test
	@Transactional
	public void testUpdateDeleteMessageNotAuthorized() {
		// ROLE_MEMBER user
		SecurityContextHolder.getContext().setAuthentication(
				new UsernamePasswordAuthenticationToken("member", "member"));
		...
		SecurityContextHolder.getContext().setAuthentication(
				new UsernamePasswordAuthenticationToken("member2", "member2"));
	...
	/**
	 * Test for {@link HibernateMessageService#create(Message)}.
	 */
	@Test
	@Transactional
	...
	public void testCreateMessageForbiddenForViewer() {
		SecurityContextHolder.getContext().setAuthentication(
				new UsernamePasswordAuthenticationToken("viewer", "viewer"));
		testCreateMessage();
	}

	/**
	 * Test for {@link HibernateMessageService#remove(Message)}.
	 */
	@Test
	@Transactional
